...
config.General.workArea = 'HNL_mc_2017_diboson_pileup_trig_new'
config.section_('Data')
config.Data.splitting = 'FileBased'
config.Data.publication = False
config.Data.outLFNDirBase = '/store/user/%s/HNL_mc_2017_diboson_pileup_trig_new' % (getUsernameFromSiteDB())
